...
# This chunk is to aid during programming of the drawsneeded package
# and creating its README.Rmd.
# The chunk makes
# the local, version of the 'drawsneeded' package available for
# subsequent chunks.

# Check if devtools is available AND if the current directory is the package root
# by checking for the project file.
if (requireNamespace("devtools", quietly = TRUE) &&
    file.exists("drawsneeded.Rproj")) {
  devtools::load_all(".")
} else {
  # Fallback: Load the installed version of the package
  # This is for environments where the package is installed (e.g., CI, or after devtools::install())
  library(drawsneeded)
}
...
knitr::opts_chunk$set(
  ...
  out.width = "100%",
  message = FALSE, # Suppress messages (like package loading messages)
...
```{r install, eval = FALSE, message=FALSE, warning=FALSE, echo=TRUE}
  if (!requireNamespace("devtools", quietly = TRUE)) {
...
```{r tiny-defects-all-plots, fig.width=14, fig.height=7}
...
defect rate for the minimum combination of n and k
given a _posited_ defect rate of 0.001, allowed defect rate of 0.01, and 
certainty of 0.95. The brown graphs show what happens with the number of 
draws needed when we vary
...
```{r zero-defects-all-plots,  fig.width=14, fig.height=7}
