...
This very tiny package has one function, drawsneeded().
...
So you set certainty to 0.95,
You decide that the maximum number of samples you are willing to 
draw and check is 500.
So you set max_n to 500.

```{r example 0.1 percent errors expected}
library(drawsneeded)
