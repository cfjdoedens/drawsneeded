...
The pacakage supports monetary unit sampling.
...
* There is something very strange in fact going on: you pretend to know something
  about the file to be audited, i.e. expected_error_rate > 0 at least some times,
